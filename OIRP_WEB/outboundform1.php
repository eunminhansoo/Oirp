				...
				<form method="post" action="outboundform2.php">
					<div class="form-group row">
						<div class="col-sm-5">
							...
							<input type="text" name="citizenship" id="citizenship" class="form-control" placeholder="">
						</div>
						<div class="col-sm-5">
					...
					<div class="form-group row">
						...
						<div class="col-sm-3">
							...
							<input type="date" name="validity" id="validity" class="form-control" placeholder="">
						</div>
						<div class="col-sm-3">
							<label>Date of Issuance</label>
							<input type="date" name="issuance" id="issuance" class="form-control" placeholder="">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-10">
					...
					<div class="form-group row break">
						<div class="col-sm-4">
							...
							<input type="text" name="college" id="college" class="form-control" placeholder="">
						</div>
						<div class="col-sm-4">
							<label>Degree Program</label>
							<input type="text" name="program" id="program" class="form-control" placeholder="">
						</div>
						<div class="col-sm-2">
							<label>Year Level</label>
							<input type="text" name="yearlevel" id="yearlevel" class="form-control" placeholder="">
						</div>
					</div>
