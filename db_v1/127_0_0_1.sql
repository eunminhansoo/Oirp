...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2018 at 03:21 PM
...
-- Database: `oirp_db`
--
CREATE DATABASE IF NOT EXISTS `oirp_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `oirp_db`;
...
(1, '20180501001-out', 'outbound', 'Italy', 'Universita Degli Studi Di Brescia'),
(2, '20180501002-out', '', '', ''),
(3, '20180501003-out', '', '', '');
...
(1, '20180501001-out', 'Albert milabo', 'Support staff', 'UST', '1130-C Don Quijote St. Sampalo', 'albert@gmail.com', '+63 2-406-1611', 'PHP 8,001 - PHP 135,000', 'tess milabo', 'Support Staff', 'UST', '1130-C Don Quijote St. Sampalo', 'bertisay@yahoo.com', '+63 2-406-1611', 'PHP 8,001 - PHP 135,000'),
(2, '20180501002-out', 'SOFIO RAMER MAGSINO ORTEGA', 'Web Development', 'Singapore Inc.', '1130-C Don Quijote St. Sampalo', 'al@gmail.com', '+63 2-406-1611', 'PHP 500,001 - PHP 1,000,000', 'MARICEL PAGDANGANAN ORTEGA', 'Nurse', 'Hospital Meycauayan', '1130-C Don Quijote St. Sampalo', 'a@gmail.com', '+63 2-406-1611', 'PHP 250,001 - PHP 500,000'),
(3, '20180501003-out', 'adasdadad', 'sdfasfsdf', 'ljljljljl', 'ljlkkjljljl', 'al@gmail.com', '+63 2-406-1611', 'PHP 135,001 - PHP 250,000', 'qwertyuiopsdfghjkl;', 'wertyuiol,nmjhertyui', 'excvtbynumihfervtbyn', 'TGVGBYHN234567', 'a@gmail.com', '+63 2-406-1611', 'PHP 250,001 - PHP 500,000');
...
INSERT INTO `notification` (`STUDENT_COUNT`, `STUDENT_ID`, `LASTNAME`, `FIRSTNAME`, `COMMENT_STATUS`, `APPLICATION_FORM`, `COLLEGE`, `STATUS`, `COURSE`) VALUES
(1, '20180501001-out', 'Milabo', 'Aimee Maricris', 0, 'outbound', '', '', ''),
(2, '20180501002-out', 'Orteg', 'Dave Peter Lorenzo', 0, 'outbound', '', '', ''),
(3, '20180501003-out', 'Atilano', 'Jeanina', 0, 'outbound', '', '', '');
...
(1, '20180501001-out', 'Filipino', NULL, '23fyugJHFUJ', '2030-11-23', '2015-11-23', '1130-C Don Quijote St. Sampaloc Manila', '+63 2-406-1611', '+63 974-887-6512', 'Institute of Information and Computing Sciences ', 'BS. IT', '4'),
(2, '20180501002-out', 'Filipino', NULL, '1Hdy2fassss', '2030-03-25', '2015-03-25', '45 Pelican St., Francis Vill., Meycauayan, Bulacan', '+63 2-815-4895', '+63 974-887-6512', 'Institute of Information and Computing Sciences ', 'BS. IT', '4'),
(3, '20180501003-out', 'Filipino', NULL, '23fdjws', '2030-01-01', '2015-01-01', '1130-C Don Quijote St. Sampaloc Manila', '+63 2-406-1611', '+63 974-887-6512', 'Institute of Information and Computing Sciences ', 'BS. IT', '4');
...
(1, '20180501001-out', 'BS. Civil Engineering', 'CE 312', 'CE 322', 'CE 414', '', '', 'Scholarship', ' ', 'AIMS', ' ', ' ', ' ', ' ', ' '),
(2, '20180501002-out', 'BS. Chemistry', 'CHEM 201', 'CHEM 201L', 'CHEM CORR', '', '', 'StudyTour', ' ', '1 Sem', ' ', 'No', ' ', ' ', ' '),
(3, '20180501003-out', 'Bachelor of Fine Arts, Major Advertising Arts', 'FIGDRW 1', 'PHOTO 1', '', '', '', 'StudyTour', ' ', 'Others', ' HELLO', 'No', ' ', ' ', ' ');
...
(1, '2018-05-01', 'outbound', '20180501001-out', 'dongbaekminsoo@gmail.com', 'MTEvMjMvMTk5Nw==', 'Milabo', 'Aimee Maricris', '', 'Female', 'MTEvMjMvMTk5Nw==', 20, 'Manila', 'Pending', 'Submitted PDF'),
(2, '2018-05-01', 'outbound', '20180501002-out', 'daveplortega@gmail.com', 'MDMvMjUvMTk5OA==', 'Orteg', 'Dave Peter Lorenzo', 'Pagdangana', 'Male', 'MDMvMjUvMTk5OA==', 20, 'Bulacan', 'Pending', 'Submitted PDF'),
(3, '2018-05-01', 'outbound', '20180501003-out', 'nina@gmail.com', 'MDEvMDEvMTk5OA==', 'Atilano', 'Jeanina', '', 'Female', 'MDEvMDEvMTk5OA==', 20, 'Manila', 'Pending', 'Submitted PDF');
...
(1, '20180501001-out', 'outbound', 'Milabo', 'aimeepdf.pdf', 'cert.jpg', '2018-05-01'),
(2, '20180501002-out', 'outbound', 'Orteg', 'davepdf.pdf', 'cert.jpg', '2018-05-01'),
(3, '20180501003-out', 'outbound', 'Atilano', 'ninapdf.pdf', 'cert.jpg', '2018-05-01');
