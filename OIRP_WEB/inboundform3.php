				...
				<form method="post">
					<div class="form-group row">
						<div class="col-sm-10">
							...
							<input type="text" name="proposedProg" id="proposedProg" class="form-control" pattern="(\p{L})([a-zA-Z0-9.,()'+-!&*|/: ]).{1,45}" maxlength="45" required value="<?php echo $getSel_PROPOSED_PROG_INBOUND?>">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-10">
							...
							<div class="input-group">
							    ...
							    <input type="text" name="course1" id="course1" class="form-control" pattern="(\p{L})([a-zA-Z0-9.,()'+-!&*|/: ]).{1,45}" maxlength="45" required value="<?php echo $getSel_COURSE_1_INBOUND?>">
							</div>
						</div>
						<div class="col-sm-10">
							<div class="input-group">
							    <span class="input-group-addon">2.</span>
							    <input type="text" name="course2" id="course2" class="form-control" pattern="(\p{L})([a-zA-Z0-9.,()'+-!&*|/: ]).{1,45}" maxlength="45" required value="<?php echo $getSel_COURSE_2_INBOUND?>">
							</div>
						</div>
						<div class="col-sm-10">
							<div class="input-group">
							    <span class="input-group-addon">3.</span>
							    <input type="text" name="course3" id="course3" class="form-control" pattern="(\p{L})([a-zA-Z0-9.,()'+-!&*|/: ]).{1,45}" maxlength="45" value="<?php echo $getSel_COURSE_3_INBOUND?>">
							</div>
						</div>
						<div class="col-sm-10">
							<div class="input-group">
							    <span class="input-group-addon">4.</span>
							    <input type="text" name="course4" id="course4" class="form-control" pattern="(\p{L})([a-zA-Z0-9.,()'+-!&*|/: ]).{1,45}" maxlength="45" value="<?php echo $getSel_COURSE_4_INBOUND?>">
							</div>
						</div>
						<div class="col-sm-10">
							<div class="input-group">
							    <span class="input-group-addon">5.</span>
							    <input type="text" name="course5" id="course5" class="form-control" pattern="(\p{L})([a-zA-Z0-9.,()'+-!&*|/: ]).{1,45}" maxlength="45" value="<?php echo $getSel_COURSE_5_INBOUND?>">
							</div>
						</div>
					</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-7">
							...
							<input type="text" name="research" id="research" class="form-control" pattern="(\p{L})([a-zA-Z0-9.,()'+-!&*|/: ]).{1,50}" maxlength="50" value="<?php echo $getSel_RESEARCH_TOPIC_INBOUND?>">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-5">
							<label>Reason for Application</label>
							<input type="text" name="reason" id="reason" class="form-control" pattern="(\p{L})([a-zA-Z0-9.,()'+-!&*|/: ]).{1,25}" maxlength="25" required value="<?php echo $getSel_REASON_STUDYING_INBOUND?>">
						</div>
						<div class="col-sm-5">
							<label>Disciplinary Status/Action</label>
							<input type="text" name="disciplinary" id="disciplinary" class="form-control" pattern="(\p{L})([a-zA-Z0-9.,()'+-!&*|/: ]).{1,25}" maxlength="25" required value="<?php echo $getSel_DESCRIPTION_ACTION_STATUS_INBOUND?>">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-6">
