...
<html>
	...
	<body>
		...
		<form method="post">
			<div class="col-sm-4 threepanel" style="padding-bottom: ">
				<h2>UST Identity</h2>
			...
			<div class="col-sm-4 threepanel" style="font-size: 14px; border-right: 1px solid white; border-left: 1px solid white;">
				<h2>Mission</h2>
